...
export class AppComponent {
  ...
  // Inicialitzem la llista de Pokemons
  constructor() {
    this.pokemons = [
  ...
  // Mètode que rep el Pokemon modificat des del component fill
  // Busca el Pokemon per ID i actualitza els seus valors
  updatePokemon(event: Pokemon) {
    // Troba l'índex del Pokemon a l'array utilitzant el seu ID
